...
mfwk = ModelFramework(network_name = "home network", system_file = "../systems/system01.py")
...
var_tf_r0 = ("fd", (2.0, 240.), 24, std_nruns, 1, 0)
var_tf_r1 = ("fd", (2.0, 160.), 24, std_nruns, 1, 1)
...
print "Creating pivoted heatmap dataframe, saving..."
...
print "\tSimulation:\t", time_sim_graph - time_setup_sim
print "\tOutput:\t\t", time_end - time_sim_graph
